...
print("first letter of the mayor's name:", chicago_mayor[0])
print("last letter of mayor's name:", chicago_mayor[-1])
# first number in slicing is inclusive
# second is exclusive
# son
print("last three letters of mayor's name")
last_name = "lastname"
print("first letter of last name:", last_name[0])

poppins = "supercalifragiliisticexpialidocious"
print(len(poppins)) # output: 34 
declaration_of_indepedence = "all men are created equal and endowed with  unalienable Rights, including Life, Liberty and the pursuit of Happiness."
